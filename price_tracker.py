"""
Nature Made Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from Nature Made.

Docs  : https://docs.brightdata.jp/scraping-automation/web-scraper-api/overview
Info  : https://brightdata.jp/products/insights/price-tracker/nature-made
"""
...
# Set your Web Scraper ID after building your Nature Made scraper:
# https://brightdata.jp/products/web-scraper/nature-made
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Nature Made scraper at: https://brightdata.jp/products/web-scraper/nature-made\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of Nature Made product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover Nature Made products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a Nature Made category page.

    Example:
        results = discover_by_category("https://naturemade.com/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.naturemade.com/product/sample-item-123456",
        # Add more Nature Made product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "nature-made_prices.json"
    ...
    # cat_results = discover_by_category("https://naturemade.com/category/sample", limit=50)
